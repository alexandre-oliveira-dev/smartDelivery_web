    ...
    <section style={section}>
      ...
      <Card style={{ width: "350px" }}>
        <Row style={{width:"100%",display:"flex",justifyContent:"center"}}>
            <Tag style={{fontSize:'30px',padding:"10px"}} color="green">R$25,00 /mês</Tag>
            <Divider></Divider>
            ...
            <Divider></Divider>
             <Typography.Text>Cancele sem compromisso quando quiser!</Typography.Text>
             <br />
             <Button type="link" href="/cadastro">Começar agora!</Button>
        </Row>
      </Card>
    </section>
  );
